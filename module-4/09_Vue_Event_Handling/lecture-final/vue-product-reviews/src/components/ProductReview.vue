<template>
    <div class="main">
        ...
        <a href="#" v-if="!showForm" v-on:click.prevent="showForm = true;">Add a Review</a>
...
export default {
    ...
    computed: {
        ...
        isFormValid() {
            // return true if all review fields have something in them (they are truthy)
            let isValid = this.newReview.reviewer && this.newReview.title &&
