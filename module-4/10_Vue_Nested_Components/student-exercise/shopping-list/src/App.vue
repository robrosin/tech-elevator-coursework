<template>
  <div id="app">
    ...
    <shopping-search v-on:search-change="searchQuery"></shopping-search>
      <shopping-list title="Grocery Store" v-bind:data="groceries" v-bind:search="searchString"></shopping-list>
      <shopping-list title="Costco" v-bind:data="costco" v-bind:search="searchString"></shopping-list>
      <shopping-list title="Target" v-bind:data="target" v-bind:search="searchString"></shopping-list>
  </div>
</template>
