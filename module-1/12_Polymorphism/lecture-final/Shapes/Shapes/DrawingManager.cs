...
namespace Shapes
{
    public class DrawingManager
    {
        ...
        public void Run()
        {
            // TODO 09 Add "Add a Graphic" to the menu and handle the choice (call NewGraphic())
            // TODO 10 Add "Add a Text object" to the menu and handle the choice (call NewText())
            while (true)
            {
                Console.Write(@"
    1) Add a Circle
...
Please choose an option: ");
        ...
        private void NewGraphic()
        {
            ...
            // TODO 11 Create a new Graphic and Add it to the list of drawable objects
        ...
        private void NewText()
        {
            ...
            // TODO 12 Create a new Text and Add it to the list of drawable objects
        ...
        // TODO 01 Change GetColor to list the colors for the user to choose.
