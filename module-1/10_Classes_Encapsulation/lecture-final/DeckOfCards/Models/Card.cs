...
namespace DeckOfCards.Models
{
    ...
    public class Card
    {
        ...
        // Make the dictionary of suit symbols static so that only one copy is ever create
        ...
        // Make the dictionary of values static so that only one copy is ever create
        ...
        // Make the Suit Property read-only, so that it can ONLY be set in the constructor
        ...
        // Make the Value of the card read-only, so that it can ONLY be set in the constructor
        /// <summary>
        ...
        // Add a Property for Suit Symbol
        /// <summary>
        ...
        public string CardName
        {
            get
            {
                // Add the Symbol to the card name
