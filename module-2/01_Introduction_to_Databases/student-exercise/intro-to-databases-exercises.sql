...
select name, region from country where region like '%america' and region != 'caribbean'
...
select name, population, gnp from country where population < 100000000 and gnp > 1000000
