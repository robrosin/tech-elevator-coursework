...
namespace TechElevator.Web.DAL
{
    public class MockStarWarsDAO : IStarWarsDAO
    {
        ...
        private List<Film> films = new List<Film>()
        {
            ...
            new Film() { Id = "swix", Name = "Star Wars Episode IX", Length = 155, YearReleased = 2019, ImageUrl = "https://i0.wp.com/culturedvultures.com/wp-content/uploads/2019/04/Star-Wars-Episode-9.jpg" }
        };
