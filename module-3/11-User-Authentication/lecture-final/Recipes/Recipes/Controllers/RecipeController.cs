...
namespace Recipes.Controllers
{
    public class RecipeController : RecipesBaseController
    {
        ...
        /// <returns></returns>
        // TODO 06 (Controller): Authorize...ANY user can see recipes
        ...
        public IActionResult Detail(int id)
        {
            ...
            // Recipe was found. Invoke the Detail view to show it.
            return View(recipe);
        }
        ...
        /// </summary>
        /// <returns></returns>
        // TODO 06 (Controller): Authorize...Must be logged in to Add a recipe
        [HttpGet]
        ...
        public IActionResult Add(RecipeVM vm)
        {
            ...
            recipeInProgress.ImageFile = vm.Recipe.ImageFile;

            // TODO 07 (Controller): Get the user id and put it here
            recipeInProgress.CreatedById = authProvider.GetCurrentUser().Id;
